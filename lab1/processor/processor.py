...
class Processor:
    ...
    def __init__(self, terms_file, documents_dir) -> None:
        self.clauses = []
        self.terms = []
    ...
    def make_query(self, query: str) -> dict:
        ...
        return self.__read_docs(docs)

    def __read_docs(self, docs: set) -> dict:
        result = {}
        for doc in docs:
    ...
    def __check_term_existance(self, term) -> bool:
